...
<div class="flex m-8 mt-16">
  ...
  <div class="flex flex-col ml-10">
    <span
      class="text-secondary text-lg flex-1 font-poppins-regular">Number of wins : <b>{data.user.numberOfWins}</b></span>
    <span class="text-secondary text-lg flex-1 font-poppins-regular">Number of looses : <b>{data.user.numberOfLoses}</b></span>
    <span
      class="text-secondary text-lg flex-1 font-poppins-regular">Win Rate Ratio : <b>{getWinRateRation(data.user.numberOfWins, data.user.numberOfLoses)}</b></span>
  </div>
</div>
