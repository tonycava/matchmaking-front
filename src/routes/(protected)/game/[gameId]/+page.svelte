...
<div class="flex flex-col lg:flex-row">
  <div class="text-3xl text-secondary m-4 flex gap-2 justify-center lg:justify-start flex-1">Round : <b>{game.round}</b>
  </div>
  <Score scores={game.whoWin} />
  {#if game.state === 'choosing'}
    <div class="text-3xl text-secondary m-4 relative flex-1 lg:justify-end text-center justify-center gap-2 flex">
  ...
  {:else if game.state === 'finished'}
    <div class="text-3xl text-secondary m-4 relative flex-1 lg:justify-end text-center justify-center gap-2">
